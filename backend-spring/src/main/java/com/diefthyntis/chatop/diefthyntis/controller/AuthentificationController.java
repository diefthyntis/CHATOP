...
public class AuthentificationController {
	...
	public ResponseEntity<?> registerUser(final @RequestBody RegisterRequest registerRequest) {
		...
		/*
		 * dans cette application Chatop, il y a un parti pris de créer le compte
		 * utilisateur et de redigirer tout de suite sur la page du gestion du profil
		 * utilisateur mais cela pourrait etre fait en 2 temps où le user serait obligé
		 * de se connecter après validation de la création de son compte
		 */
