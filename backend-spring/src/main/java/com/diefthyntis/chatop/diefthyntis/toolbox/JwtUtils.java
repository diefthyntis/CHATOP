...
import com.diefthyntis.chatop.diefthyntis.security.UserDetailsImpl;
...
public class JwtUtils {
	...
	public String generateJwtToken(Authentication authentication) {
		...
		/*
		 * Jwts.builder est une méthode statique elle prend les infos nécessaires pour
		 * les distribuer entre le header, le payload et la signature
		 */
	}
