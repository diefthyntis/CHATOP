...
public class FileUtils {
	 ...
	 * @return an Optional containing the file extension, or an empty Optional if no
	 *         extension is found
	 */
	...
	/**
	 * Generates a string representation of the current date and time in the format
	 * "yyyyMMddhhmmss" and the extension.
	 *
	 * @param ext the file extension to append to the generated string
	 * @return the generated file name composed of the generated string and the
	 *         extension.
	 */
